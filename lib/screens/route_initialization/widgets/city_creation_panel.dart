...
class CityCreationPanel extends StatelessWidget {
  final double inputWidth;
  const CityCreationPanel({
  ...
  Widget build(BuildContext context) {
    final blocState = BlocProvider.of<RouteInitializationBloc>(context).state as OnCityCreation;
    return CreationPanel(
      child: Column(
        children: [
          ...
          MaterialButton(
            onPressed: (){
              BlocProvider.of<RouteInitializationBloc>(context).add(EndCityCreation());
            },
